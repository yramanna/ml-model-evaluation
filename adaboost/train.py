...
from model import DecisionTree, MajorityBaseline, AdaBoostClassifier, MODEL_OPTIONS, Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', '-m', type=str, choices=['majority_baseline', 'decision_tree', 'adaboost'], default='decision_tree',
